// Nodevision/ApplicationSystem/public/NodevisionConsoleCommandList.mjs
// This module defines the browser-console command catalogue used by the floating Nodevision Console and toolbar command widget.
