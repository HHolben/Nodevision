...
export const NODEVISION_EVENT_DEFINITIONS = Object.freeze([
  ...
  { id: "speech.started", description: "Browser speech synthesis started an utterance." },
  { id: "speech.boundary", description: "Browser speech synthesis reported a boundary." },
  { id: "speech.paused", description: "Browser speech synthesis paused." },
  { id: "speech.resumed", description: "Browser speech synthesis resumed." },
  { id: "speech.finished", description: "Browser speech synthesis finished an utterance." },
  { id: "speech.cancelled", description: "Browser speech synthesis was cancelled or errored." },
