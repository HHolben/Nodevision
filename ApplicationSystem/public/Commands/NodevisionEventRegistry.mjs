...
export const NODEVISION_EVENT_DEFINITIONS = Object.freeze([
  ...
  { id: "speech.recognition.started", description: "The selected recognition provider started listening or processing audio." },
  { id: "speech.recognition.partial", description: "The selected recognition provider reported transient recognition text." },
  { id: "speech.recognition.processing", description: "The selected recognition provider is processing captured audio." },
  { id: "speech.recognition.final", description: "The selected recognition provider reported finalized recognition text." },
  { id: "speech.recognition.finished", description: "The selected recognition provider finished a recognition session." },
  { id: "speech.recognition.cancelled", description: "The selected recognition provider cancelled a recognition session." },
  { id: "speech.recognition.error", description: "The selected recognition provider reported a recognition error." },
