...
function expandRegion(regionElement) {
  ...
  function checkIfFileExists(filePath) {
      // Placeholder function, implement actual logic to check if file exists
      return true; // Assuming file exists for demo purposes
  }

  // Create or fetch the collapsed node ID
  function generateCollapsedNodeId(targetPath) {
