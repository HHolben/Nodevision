...
function buildBindingsFromScheme(scheme) {
  ...
  return {
    ...
    inspect: getKey("Inspect/Modify", defaultBindings.inspect),
    cycleCamera: getKey("Cycle Camera", defaultBindings.cycleCamera),
    ...
    gamepad: {
      ...
      inspect: normalizeGamepadBinding(scheme?.["Inspect/Modify"]?.gamepad) || normalizeGamepadBinding(defaultGamepadBindings.inspect),
...
export async function loadControlScheme(state) {
  ...
  state.controlBindings = {
    ...
    gamepad: {
      ...
      inspect: normalizeGamepadBinding(defaultGamepadBindings.inspect),
